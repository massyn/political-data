"""US Median Home Sales Price (quarterly, USD) — FRED API series MSPUS.

Requires environment variable: FRED_API_KEY
Get a free key at: https://fred.stlouisfed.org/docs/api/api_key.html

Without a FRED key this collector cannot run. Manually look up the value at:
...
def collect() -> list[tuple]:
    ...
    if not api_key:
        raise RuntimeError(
            ...
            "or update manually from https://fred.stlouisfed.org/series/MSPUS"
        )
    url = (
        f"https://api.stlouisfed.org/fred/series/observations"
        f"?series_id=MSPUS&api_key={api_key}&file_type=json"
...
if __name__ == "__main__":
    ...
    if rows:
        ...
        print("No data — set FRED_API_KEY or update manually from https://fred.stlouisfed.org/series/MSPUS")
